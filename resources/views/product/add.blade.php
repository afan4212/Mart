                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nama" class="form-control" placeholder="Nama Product ..." required="required">
                        </div>
                        <div class="form-group">
<!--                           <label for="umur">Kategori Product</label>
                     ...
                     <div class="form-group">
                          ...
                          <textarea  name="keterangan" class="form-control" placeholder="Keterangan Product" required="required"></textarea>
                        </div>
